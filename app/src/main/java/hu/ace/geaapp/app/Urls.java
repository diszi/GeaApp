...
public class Urls {
    ...
    public static String GET_VEHICLE_LIST = null;
    ...
    public static void setURLs(String ipAddress){
        ...
        GET_VEHICLE_LIST = "http://192.168.133.51/maxrest/rest/os/ACE_GEA_ASSET?_dropnulls=0&STATUS=ACTIVE&CLASSSTRUCTUREID=1053&ASSETTYPE=VEHICLE";//get all vehicle from Maximo
