...
public class StructFeatures implements Serializable {

    public static String SERIALIZABLE_NAME = "ASSET_VEHICLE_STRUCTURAL_FEATURES"; //szerkezeti jellemzok
    ...
    public StructFeatures(){}

    public StructFeatures(int ablakmoso, int ablaktorlo, int akkumulator, int biztonsagiov, int futomuall, int feklampa, int fekrendszer,
    ...
    public StructFeatures(String id, String description,int ablakmoso, int ablaktorlo, int akkumulator, int biztonsagiov, int futomuall, int feklampa, int fekrendszer,
                          int gumikall, int helyzetjelzo, int hutorendszer, int inditomotor, int iranyjelzo, int kipufogorendszer,
                          int kontrolllampak, int kormanymu, int kurt, int olajfolyas, int olajnyomas, int rogzitofek,
                          int tengelykapcsolo, int tolatolampa, int tompitottfenyszoro, int tavolsagifenyszoro, int toltes,
                          int utasterall, int visszapillanto,int szelvedoall,String note){
